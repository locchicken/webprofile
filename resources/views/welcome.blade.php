                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="{{('public/frontend/image/logo.png')}}" alt="" /></a>
                        </div>
                        ...
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                <?php 
                                    ...
                                    {
                                    ?>
                                         <li><a style="color: red;font-weight: bold;" href="{{URL::to('/dang-nhap')}}">Admin</a></li>
                                    <?php
                                    }
                                    else{
                                    ?>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        @foreach($cate as $key=>$cate_data)       
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title"><a href="{{URL::to('/danh-muc-san-pham/'.$cate_data->category_id)}}">{{$cate_data->category_name}}</a></h4>
                                </div>
                            </div>
                        @endforeach
                        ...
                        <div class="brands_products"><!--brands_products-->
                            ...
                            <div class="brands-name">
                                @foreach($brand as $key=>$brand_data)
                                <ul class="nav nav-pills nav-stacked">
                                    <li><a href="{{URL::to('/thuong-hieu/'.$brand_data->brand_id)}}"> <span class="pull-right">(50)</span>{{$brand_data->brand_name}}</a></li>
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="{{asset('public/frontend/image/shipping.jpg')}}" alt="" />
                        </div><!--/shipping-->
